...
public abstract class FieldUtil { 
    ...
    public static final <T> T getValue(Object host, String fieldName) throws ItemNotFoundException { 
        try { 
     ...
     * @throws SecurityException if access this field is refused 
     */ 
    public static final void setValue(Object host, String fieldName, Object value) throws ItemNotFoundException { 
        try { 
     ...
     */ 
    public static final void setValueAutoConvert(Object host, String fieldName, String value) throws ItemNotFoundException { 
        try { 
    ...
    public static final List<Field> getAllFields(Class<?> clazz) { 
        ...
        do { 
            hello.world.esper.CollectionUtil.addAll(outList, clazz.getDeclaredFields()); 
