...
public class TemperatureEventHandler {
    ...
    EPStatement warningEventStatement;
    EPStatement monitorEventStatement;

 
    StatementSubscriber criticalEventSubscriber; 
    StatementSubscriber warningEventSubscriber; 
    StatementSubscriber monitorEventSubscriber;
